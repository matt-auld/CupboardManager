 ...
 */
public class DeleteShoppingItemsTest extends ItemsBaseTest {
    ...
    public void setUp() throws Exception {
        ...
        rowsDeleted = provider.delete(DBContentProvider.SHOPPING_ITEMS.CONTENT_URI,
    ...
    public void testResultShouldHave2Records() throws Exception {
        Cursor cursor = provider.query(DBContentProvider.SHOPPING_ITEMS.CONTENT_URI,
                null, null, null, null);
